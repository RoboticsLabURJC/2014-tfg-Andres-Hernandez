...
if __name__ == "__main__":
	...
	if displayGui:
		...
		gui.addState(3, "Rotational Search", True, 836.0, 777.0, 0)
	...
	state3 = State3(3, True, interfaces, 100, state0, gui)
