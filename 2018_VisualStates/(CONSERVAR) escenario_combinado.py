...
class State12(State):
	...
	def runCode(self):
		...
		maskRGBTot = maskRGBPrimary+maskRGBGreen
		...
		if():
		crosshair,f = self.interfaces.findCrosshair(input_imageData,maskRGBPrimary,maskRGBGreen)
		print "F: %d" % len(f)
...
class Tran17(ConditionalTransition):
	def __init__(self, id, destinationId, interfaces):
		ConditionalTransition.__init__(self, id, destinationId)
		self.interfaces = interfaces
...
class Tran22(TemporalTransition):

	def runCode(self):
		pass

class Tran23(TemporalTransition):

	def runCode(self):
		pass

class Tran18(TemporalTransition):
...
if __name__ == "__main__":
	...
	if displayGui:
		...
		gui.addState(1, "Apriltag Beacon Tracking", False, 843.0, 1196.0, 0)
		gui.addState(3, "Rotational Search", False, 840.0, 956.0, 0)
		gui.addState(4, "Land", False, 1155.0, 1201.0, 0)
		gui.addState(11, "Switch Beacon", False, 1004.0, 1055.0, 0)
		gui.addState(12, "Controlled Take Off", True, 841.0, 745.0, 0)
		gui.addState(13, "Color Beacon Landing", False, 1155.0, 961.0, 0)
		gui.addState(14, "Search Color Beacon", False, 995.0, 747.0, 0)

		gui.addTransition(12, "Beacon Tracking time up", 1, 11, 1005.5, 1198.0)
		gui.addTransition(11, "Beacon Found", 3, 1, 841.0, 1082.5)
		gui.addTransition(17, "Color Beacon Stage", 3, 14, 995.0, 836.0)
		gui.addTransition(13, "Beacon Switched", 11, 3, 1001.0, 955.0)
		gui.addTransition(14, "Apriltag Beacon Stage", 12, 3, 842.0, 833.5)
		gui.addTransition(22, "Landing Time", 13, 4, 1155.5, 1055.0)
		gui.addTransition(23, "Color Beacon Lost", 13, 14, 1093.0, 881.0)
		gui.addTransition(18, "Landing Beacon Found", 14, 13, 1151.5, 747.0)
	...
	state13 = State13(13, False, interfaces, 100, state0, gui)
	state14 = State14(14, False, interfaces, 100, state0, gui)
	...
	tran17 = Tran17(17, 14, interfaces)
	state3.addTransition(tran17)
	...
	tran22 = Tran22(22, 4, 0)
	state13.addTransition(tran22)

	tran23 = Tran23(23, 14, 0)
	state13.addTransition(tran23)

	tran18 = Tran18(18, 13, 0)
	state14.addTransition(tran18)
